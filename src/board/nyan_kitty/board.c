...
#include "board/nyan_kitty/power_ops.h"
#include "boot/fit.h"
...
static int board_setup(void)
{
	...
	switch (id) {
	case BOARD_ID_REV0:
		fit_override_kernel_compat("google,nyan-kitty-rev0");
		break;
	case BOARD_ID_REV1:
		fit_override_kernel_compat("google,nyan-kitty-rev1");
		break;
	case BOARD_ID_REV2:
		fit_override_kernel_compat("google,nyan-kitty-rev2");
		break;
	case BOARD_ID_REV3:
		fit_override_kernel_compat("google,nyan-kitty-rev3");
		break;
	case BOARD_ID_REV4:
		fit_override_kernel_compat("google,nyan-kitty-rev4");
		break;
	case BOARD_ID_REV5:
		fit_override_kernel_compat("google,nyan-kitty-rev5");
		break;
	case BOARD_ID_REV6:
		fit_override_kernel_compat("google,nyan-kitty-rev6");
		break;
	case BOARD_ID_REV7:
		fit_override_kernel_compat("google,nyan-kitty-rev7");
		break;
	case BOARD_ID_REV8:
		fit_override_kernel_compat("google,nyan-kitty-rev8");
		break;
	case BOARD_ID_REV9:
		fit_override_kernel_compat("google,nyan-kitty-rev9");
		break;
	case BOARD_ID_REV10:
		fit_override_kernel_compat("google,nyan-kitty-rev10");
		break;
	default:
