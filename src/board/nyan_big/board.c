...
static int board_setup(void)
{
	...
	case BOARD_ID_REV5:
		...
		break;
	case BOARD_ID_REV6:
		fit_override_kernel_compat("google,nyan-big-rev6");
		break;
	case BOARD_ID_REV7:
		fit_override_kernel_compat("google,nyan-big-rev7");
		break;
	case BOARD_ID_REV8:
		fit_override_kernel_compat("google,nyan-big-rev8");
		break;
	case BOARD_ID_REV9:
		fit_override_kernel_compat("google,nyan-big-rev9");
		break;
	case BOARD_ID_REV10:
		fit_override_kernel_compat("google,nyan-big-rev10");
		break;
	default:
