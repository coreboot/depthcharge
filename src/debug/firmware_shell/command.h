 ...
 */
#ifndef __DEBUG_FIRMWARE_SHELL_COMMAND_H__
#define __DEBUG_FIRMWARE_SHELL_COMMAND_H__
...
extern int timed_wait(int sec, int print);
...
#endif /* __DEBUG_FIRMWARE_SHELL_COMMAND_H__ */
