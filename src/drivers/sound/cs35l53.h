...
#if !CONFIG(DRIVER_SOUND_CS35L53_1_5MHZ_REFCLK)
...
#else
#define CS35L53_PLL_REFCLK_FREQ			0x00000360
#define CS35L53_ASP_BCLK_FREQ			0x0000001B
#define CS35L53_ASP_TX_RX_WIDTH1		0x10100200
#define CS35L53_ASP_RX_WL			0x00000010
#endif

#if !CONFIG(DRIVER_SOUND_CS35L53_INTERNAL_BOOST)
#define CS35L53_AMP_EN				0x00000001
#else
#define CS35L53_AMP_EN				0x00000021
#endif
