...
static const sndw_cmd alc1321_beep_init_cmds[] = {
	...
	{ .cmdtype = cmd_write, .regaddr = 0xc081, .regdata = 0xFF, },
	...
	{ .cmdtype = cmd_write, .regaddr = 0x0049, .regdata = 0x01, },
	{ .cmdtype = cmd_write, .regaddr = 0x8000, .regdata = 0x67, },
	{ .cmdtype = cmd_write, .regaddr = 0x8001, .regdata = 0x80, },
	{ .cmdtype = cmd_write, .regaddr = 0x8002, .regdata = 0x00, },
	{ .cmdtype = cmd_write, .regaddr = 0x8003, .regdata = 0x00, },
	...
	{ .cmdtype = cmd_write, .regaddr = 0xC570, .regdata = 0x0B, },
	{ .cmdtype = cmd_write, .regaddr = 0xde03, .regdata = 0x09, }
};
