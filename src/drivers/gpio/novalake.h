...
#ifndef __DRIVERS_GPIO_NOVALAKE_H__
#define __DRIVERS_GPIO_NOVALAKE_H__

#include "drivers/soc/intel_gpio.h"

/* TODO: b/500364196 Reformat pad definitions for NVL. */
#define INC(x) ((x) + 1)
...
#define GPP_VGPIO3_USB_OCB_TX_2		INC(GPP_VGPIO3_USB_OCB_TX_1)
...
#define GPP_VGPIO3_ESPI_2		INC(GPP_VGPIO3_ESPI_1)
...
#define GPP_VGPIO3_ESPI_12		INC(GPP_VGPIO3_ESPI_11)
...
#define PAD_CFG_DW_OFFSET	0x800
#define HOSTSW_OWN_REG_OFFSET	0x2c0

GpioOps *new_novalake_gpio_input_from_coreboot(uint32_t port);

#endif /* __DRIVERS_GPIO_NOVALAKE_H__ */
