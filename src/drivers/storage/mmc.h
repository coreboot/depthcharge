...
typedef struct MmcCtrlr {
	...
	enum mmc_timing {
		/* 400KHz Max Open-Drain */
		MMC_TIMING_INITIALIZATION	= 0,
		MMC_TIMING_MMC_LEGACY		= 1,
		MMC_TIMING_MMC_HS		= 2,
		MMC_TIMING_SD_DS		= 3,
		MMC_TIMING_SD_HS		= 4,
		MMC_TIMING_UHS_SDR12		= 5,
		MMC_TIMING_UHS_SDR25		= 6,
		MMC_TIMING_UHS_SDR50		= 7,
		MMC_TIMING_UHS_SDR104		= 8,
		MMC_TIMING_UHS_DDR50		= 9,
		MMC_TIMING_MMC_DDR52		= 10,
		MMC_TIMING_MMC_HS200		= 11,
		MMC_TIMING_MMC_HS400		= 12,
		MMC_TIMING_MMC_HS400ES		= 13,
	} timing;
