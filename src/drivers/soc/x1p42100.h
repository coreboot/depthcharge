...
#define TCSR_UFS_PHY_CLKREF_EN		(TCSR_TCSR_REGS_REG_BASE + 0x00015118)

/* SWRM */
#define SWRM0_BASE_ADDRESS		0x06b10000
#define SWRM1_BASE_ADDRESS		0x06ad0000
#define SWRM2_BASE_ADDRESS		0x06d30000
#define SWRM3_BASE_ADDRESS		0x06ab0000

/* LPASS */
#define LPASS_AUDIO_CC_WSA_MCLK_BASE        0x06BEA000UL
#define LPASS_VA_CLK_RST_BASE               0x06D44000UL
#define LPASS_RX_CLK_RST_BASE               0x06AC0000UL
#define LPASS_WSA_CDC_RX_INP_MUX_BASE       0x06B00100UL
#define LPASS_WSA_CDC_BOOST_BASE            0x06B00500UL
#define LPASS_WSA_CDC_EC_HQ_BASE            0x06B00640UL
#define LPASS_WSA_CDC_CB_DECODE_BASE        0x06B00900UL
#define LPASS_WSA_CDC_INTR_CTRL_BASE        0x06B00360UL
#define LPASS_WSA_LPAIF_IRQ_BASE            0x06B89000UL
#define LPASS_WSA_CLK_RST_BASE              0x06B00000UL
#define LPASS_WSA_LPAIF_RD_DMA_B0_BASE      0x06B8E000UL
...
/* GCC */
#define QCOM_GCC_BASE				0x00110000
#define QCOM_GCC_CLK_CNTRL_BASE			(QCOM_GCC_BASE + 0x00010000)

/* GCC UFS registers */
#define GCC_UFS_PHY_BCR				0x57000
#define GCC_UFS_PHY_GDSCR			0x57004
#define GCC_UFS_PHY_AXI_CBCR			0x57018
#define GCC_UFS_PHY_AHB_CBCR			0x57024
#define GCC_UFS_PHY_TX_SYMBOL_0_CBCR		0x57028
#define GCC_UFS_PHY_RX_SYMBOL_0_CBCR		0x5702c
#define GCC_UFS_PHY_AXI_CMD_RCGR		0x57030
#define GCC_UFS_PHY_AXI_CFG_RCGR		0x57034
#define GCC_UFS_PHY_UNIPRO_CORE_CBCR		0x57068
#define GCC_UFS_PHY_ICE_CORE_CBCR		0x57074
#define GCC_UFS_PHY_ICE_CORE_CMD_RCGR		0x57080
#define GCC_UFS_PHY_ICE_CORE_CFG_RCGR		0x57084
#define GCC_UFS_PHY_UNIPRO_CORE_CMD_RCGR	0x57098
#define GCC_UFS_PHY_UNIPRO_CORE_CFG_RCGR	0x5709c
#define GCC_UFS_PHY_PHY_AUX_CBCR		0x570b0
#define GCC_UFS_PHY_RX_SYMBOL_1_CBCR		0x570cc
#define GCC_AGGRE_UFS_PHY_AXI_CBCR		0x570e4
#define GCC_UFS_MEM_PHY_GDSCR			0x7E000
