...
#ifndef __DRIVERS_SOC_NOVALAKE_H__
#define __DRIVERS_SOC_NOVALAKE_H__
...
#define NOVALAKE_DW_I2C_MHZ	133
...
/* PCR Interface */
#define PCH_PCR_BASE_ADDRESS	0x4100000000
...
extern int novalake_get_gpe(int gpe);

#define PCI_DEV_SLOT_TCSS_XHCI		0x0d
#define PCI_DEV_SLOT_PCH_XHCI		0x14

#endif /* __DRIVERS_SOC_NOVALAKE_H__ */
