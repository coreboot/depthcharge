...
#define TPS6699X_MAX_I2C_BUFFER_LEN 256 // max len for host cmd (used for I2C tunneling)
#define TPS6699X_DATA_CHUNK_LEN 64	// break up into chunks of multiples of 64 bytes
 ...
 *
 * @param me Chip object
 * @param broadcast_address Broadcast I2C target addresses device(s) are listening on
