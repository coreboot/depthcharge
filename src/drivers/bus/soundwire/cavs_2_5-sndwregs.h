...
/* SoundWire Shim Register */
#if CONFIG(INTEL_COMMON_SOUNDWIRE_ACE_3_x)
#define DSP_MEM_SNDW				0x36000
#elif CONFIG(INTEL_COMMON_SOUNDWIRE_ACE_1_x)
#define DSP_MEM_SNDW				0x38000
#elif CONFIG(INTEL_COMMON_SNDW_CAVS_2_5)
#define DSP_MEM_SNDW				0x2C000
#endif

/* DSP memory space common registers */
...
#if CONFIG(INTEL_COMMON_SOUNDWIRE_ACE_3_x)
#define DSP_MEM_SNDW_OFFSETS			0x8000
#define DSP_MEM_SNDW_SNDWLCAP			(0x0D80)
#define DSP_MEM_SNDW_SNDWLCAP_SC_BIT		20
#define DSP_MEM_SNDW_SNDWLCTL			(DSP_MEM_SNDW_SNDWLCAP + 0x04)
#define DSP_MEM_SNDW_SNDWLCTL_SPA		0x10000
#define DSP_MEM_SNDW_SNDWLCTL_CPA		0x800000
#define DSP_MEM_SNDW_SNDWIPPTR			(DSP_MEM_SNDW_SNDWLCAP + 0x20)
#define DSP_MEM_SNDW_SNDWxIOCTL(x)		(DSP_MEM_SNDW + (0xC * (x)) + 0x8000)
#define DSP_MEM_SNDW_SNDWxACTMCTL(x)		(DSP_MEM_SNDW + (0xE * (x)) + 0x8000)
#else /* INTEL_COMMON_SOUNDWIRE_ACE_1_x || INTEL_COMMON_SNDW_CAVS_2_5 */
...
/* DSP memory number of links register*/
#define DSP_MEM_SNDW_SNDWLCAP_SC_SHIFT(x) (7 << x)
#define DSP_MEM_SNDW_SNDWLCAP_SC DSP_MEM_SNDW_SNDWLCAP_SC_SHIFT(DSP_MEM_SNDW_SNDWLCAP_SC_BIT)
