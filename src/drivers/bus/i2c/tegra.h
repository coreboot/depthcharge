...
#ifndef __DRIVERS_BUS_I2C_TEGRA_H__
#define __DRIVERS_BUS_I2C_TEGRA_H__

#include <stdint.h>

#include "drivers/bus/i2c/i2c.h"

typedef struct TegraI2c
{
	I2cOps ops;
	void *regs;
	int controller_id;
...
typedef struct {
	...
	uint32_t spare;
} __attribute__((packed)) TegraI2cRegs;
...
#endif	/* __DRIVERS_BUS_I2C_TEGRA_H__ */
