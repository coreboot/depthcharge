...
#define S17_PHY_LINK_INTRS   (PHY_LINK_UP | PHY_LINK_DOWN | \
			      PHY_LINK_DUPLEX_CHANGE | PHY_LINK_SPEED_CHANGE)
...
/* Queue Management registe fields */
 /* egress priority 8, eg_portq = 0x2a */
#define S17_HOL_CTRL0_LAN		0x2a008888
 /* egress priority 6, eg_portq = 0x2a */
#define S17_HOL_CTRL0_WAN		0x2a666666
