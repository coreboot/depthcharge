...
static void test_diagnostics_screen_hisabled_and_hidden(void **state)
{
	...
	WILL_CLOSE_LID_IN(3);
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS, MOCK_IGNORE, MOCK_IGNORE,
			  0x0, 0x0);
...
static void test_diagnostics_screen(void **state)
{
	...
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS, MOCK_IGNORE, 1);
	/* #0: Language menu */
	WILL_PRESS_KEY(UI_KEY_UP, 0);
	WILL_PRESS_KEY(UI_KEY_ENTER, 0);
	WILL_PRESS_KEY(UI_KEY_ESC, 0);
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS, MOCK_IGNORE, 0);
	...
	WILL_PRESS_KEY(UI_KEY_ESC, 0);
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS, MOCK_IGNORE, 1);
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS_STORAGE_HEALTH);
	EXPECT_UI_DISPLAY_ANY();
	/* #2: Short storage self-test screen */
	WILL_PRESS_KEY(UI_KEY_DOWN, 0);
	WILL_PRESS_KEY(UI_KEY_ENTER, 0);
	WILL_PRESS_KEY(UI_KEY_ESC, 0);
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS, MOCK_IGNORE, 2);
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS_STORAGE_TEST_SHORT);
	EXPECT_UI_DISPLAY_ANY();
	/* #3: Extended storage self-test screen */
	WILL_PRESS_KEY(UI_KEY_DOWN, 0);
	WILL_PRESS_KEY(UI_KEY_ENTER, 0);
	WILL_PRESS_KEY(UI_KEY_ESC, 0);
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS, MOCK_IGNORE, 3);
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS_STORAGE_TEST_EXTENDED);
	EXPECT_UI_DISPLAY_ANY();
	/* #4: Quick memory test screen */
	WILL_PRESS_KEY(UI_KEY_DOWN, 0);
	WILL_PRESS_KEY(UI_KEY_ENTER, 0);
	WILL_PRESS_KEY(UI_KEY_ESC, 0);
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS, MOCK_IGNORE, 4);
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS_MEMORY_QUICK);
	EXPECT_UI_DISPLAY_ANY();
	/* #5: Full memory test screen */
	WILL_PRESS_KEY(UI_KEY_DOWN, 0);
	WILL_PRESS_KEY(UI_KEY_ENTER, 0);
	WILL_PRESS_KEY(UI_KEY_ESC, 0);
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS, MOCK_IGNORE, 5);
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS_MEMORY_FULL);
	EXPECT_UI_DISPLAY_ANY();
	/* #6: Power off (End of menu) */
	WILL_PRESS_KEY(UI_KEY_DOWN, 0);
	WILL_PRESS_KEY(UI_KEY_ENTER, 0);
	EXPECT_UI_DISPLAY(VB2_SCREEN_DIAGNOSTICS, MOCK_IGNORE, 6);
