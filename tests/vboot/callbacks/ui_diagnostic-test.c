...
static void test_diagnostics_screen_disabled_and_hidden(void **state)
{
	...
	will_return_maybe(diag_dump_storage_test_log, DIAG_TEST_SUCCESS);
...
static void test_diagnostics_screen(void **state)
{
	...
	will_return_maybe(diag_dump_storage_test_log, DIAG_TEST_SUCCESS);
	will_return_maybe(diag_storage_test_control, DIAG_TEST_SUCCESS);
	will_return_maybe(memory_test_init, DIAG_TEST_SUCCESS);
	will_return_maybe(memory_test_run, DIAG_TEST_SUCCESS);
...
static void test_diagnostics_screen_no_nvme(void **state)
{
	...
	WILL_CLOSE_LID_IN(3);
	will_return_always(diag_dump_storage_test_log, DIAG_TEST_UNIMPLEMENTED);
	will_return_maybe(ui_keyboard_read, 0);
	will_return_maybe(vb2api_gbb_get_flags, 0);
	EXPECT_UI_DISPLAY(UI_SCREEN_DIAGNOSTICS, MOCK_IGNORE, MOCK_IGNORE,
			  0xc, 0x0); /* 0xc = 0b1100 */
