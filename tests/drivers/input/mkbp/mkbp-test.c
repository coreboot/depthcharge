...
int main(void)
{
	const struct CMUnitTest tests[] = {
		...
		MKBP_V30_KEY_TEST(11, 6, KEY_DOWN),
		MKBP_V30_KEY_TEST(11, 7, KEY_UP),
		MKBP_V30_KEY_TEST(12, 6, KEY_RIGHT),
		MKBP_V30_KEY_TEST(12, 7, KEY_LEFT),
		MKBP_V30_KEY_TEST(16, 2, '-'),
		MKBP_V30_KEY_TEST(16, 3, '6'),
		MKBP_V30_KEY_TEST(16, 4, '.'),
		MKBP_V30_KEY_TEST(16, 5, '5'),
		MKBP_V30_KEY_TEST(16, 6, '4'),
		MKBP_V30_KEY_TEST(16, 7, '0'),
		MKBP_V30_KEY_TEST(17, 0, '7'),
		MKBP_V30_KEY_TEST(17, 1, '8'),
		MKBP_V30_KEY_TEST(17, 2, '9'),
