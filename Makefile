...
INCLUDES = -I$(obj) -I$(src)/src/ -I$(src)/src/arch/$(ARCH_DIR)/includes/ \
	...
	-I$(VB_SOURCE)/firmware/2lib/include \
...
CFLAGS := $(ARCH_CFLAGS) -Wall -Werror -Wstrict-prototypes $(INCLUDES) \
	-std=gnu99 $(ABI_FLAGS) -ffunction-sections -fdata-sections -ggdb3
